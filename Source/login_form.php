			...
			<script type="text/javascript" src = "assets/js/login.js"></script>
				<div id="login_box">
					...
					<form  name="login_form" method="post" action="login.php">		       	
						<ul>
						<ui><input type="text" name="id" placeholder="아이디" ></ui>
						<ui><input type="password" id="pass" name="pass" placeholder="비밀번호" ></ui> <!-- pass -->
						</ul>
						<div id="login_btn">
							<a href="#"><img src="./images/login.png" onclick="check_input()"></a>
						</div>		    	
					</form>
					</div> 
				</div> 
