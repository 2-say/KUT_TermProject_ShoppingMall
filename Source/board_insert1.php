		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					$sql = "insert into trade_board (category, subject, content, name,  regist_day, hit, id, price,  file_name, file_type, file_copied) ";
					$sql .= "values('$category','$subject','$content', '$username',   '$regist_day', 0, ";
					$sql .= "'$userid','$price' ,'$upfile_name', '$upfile_type', '$copied_file_name')";
