	...
	<body class="is-preload homepage">
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				?>
						<form  name="board_form" method="post" action="board_modify1.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
							<ul id="board_form">
								...
								<span class="col2">
									<input name= "price" type="text" value="<?=$price?>" pattern="[0-9]+">
								</span>
