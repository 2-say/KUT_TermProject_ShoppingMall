		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<div id="board_box">
					...
					<form  name="board_form" method="post" action="board_insert_com.php" enctype="multipart/form-data">
								<ul id="board_form">
							<li>
						...
						<ul class="buttons">
							...
							<button type="button" onclick="location.href='board_list_com.php'">목록</button></ui>
						</ul>
					</form>
				</div> 
			<!-- board_box -->
