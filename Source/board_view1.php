		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header-wrapper">
					...
					<ui>
						<button onclick="location.href='board_form1.php'">글쓰기</button><br>
					</ui>
					</div>
				</div>
...
?>		
		...
		<div id="banner-wrapper">
			...
			<a class="image featured"><img src="<?=$img_path?>"  alt="" style="height:303px; width: 373px; min-width: 140px;" /></a>
			<br>
			<?php
				}
			?>
			
				<ui><button onclick="location.href='tradepage.php?page=<?=$page?>'">목록</button>
